...
const PropertyValidationSchema = z.object({
  ...
  broker_company: z
    ...
    .nullable(),
  transaction_type: z
    .enum(TYPE_OF_TRANSACTION_TEXTS, {
      errorMap: () => ({
        message: VALIDATION_MESSAGES.PROPERTY.TRANSACTION_TYPE.INVALID,
      }),
    })
    .optional()
    .nullable(),
  ...
  closing_payment: z
    ...
    .pipe(
      z
        ...
        .positive(VALIDATION_MESSAGES.PROPERTY.CLOSING_PAYMENT.MUST_BE_POSITIVE)
    )
    .optional()
    .nullable(),
  ...
  house_warranty: z
    .boolean({
      errorMap: () => ({
        message: VALIDATION_MESSAGES.PROPERTY.HOUSE_WARRANTY.INVALID,
      }),
    })
    .optional()
    .nullable(),
  ...
  usufruct_registration_fee: z
    .enum(COST_SHARING_TEXTS, {
      errorMap: () => ({
        message: VALIDATION_MESSAGES.PROPERTY.USUFRUCT_REGISTRATION_FEE.INVALID,
      }),
    })
    .optional()
    .nullable(),
